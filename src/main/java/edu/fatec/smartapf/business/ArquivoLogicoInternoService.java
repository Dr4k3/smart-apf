...
import edu.fatec.smartapf.domain.ArquivoLogicoInterno;
 ...
 */
@Service
public class ArquivoLogicoInternoService {
    ...
    public Complexidade determinarComplexidade(ArquivoLogicoInterno param) {
    ...
    public void calcular(APF apf) {
		for (ArquivoLogicoInterno item : apf.getArquivosLogicosInternos()) {
