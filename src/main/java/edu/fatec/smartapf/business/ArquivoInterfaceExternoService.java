 ...
 */
@Service
public class ArquivoInterfaceExternoService {
    ...
    public Complexidade determinarComplexidade(ArquivoInterfaceExterno param) {
    ...
    public void calcular(APF apf) {
		for (ArquivoInterfaceExterno item : apf.getArquivosInterfaceExternos()) {
